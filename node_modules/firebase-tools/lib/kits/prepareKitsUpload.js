...
function _retrieveFile(githubConfig) {
    ...
    return api
        ...
        if (result.status !== 200) {
            return Promise.reject(new FirebaseError(githubConfig.path + " could not be retrieved for kit at " + githubConfig.repo));
        }
...
function _downloadSource(githubConfig) {
    ...
    return _pipeAsync(download, untar).then(function () {
...
var _packageSource = function (sourceDir, githubContext, configValues) {
    ...
    return fsAsync
        ...
        .then(function () {
        utils.logBullet(clc.cyan.bold("kits:") +
            " packaged kit source (" +
...
//# sourceMappingURL=prepareKitsUpload.js.map