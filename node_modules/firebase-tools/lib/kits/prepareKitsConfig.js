...
function _promptForKitConfig(kitName, kitConfig) {
    ...
    return prompt({ kitsource: kitName }, prompts)
        ...
        var promptAgains = _.chain(kitConfig)
            ...
            utils.logWarning(clc.yellow.bold("kits: ") + clc.bold(needsAnswer.name) + " requires a value.");
            return {
        ...
        return utils.promiseAllSettled(_.map(kitConfig, function (question) {
...
//# sourceMappingURL=prepareKitsConfig.js.map