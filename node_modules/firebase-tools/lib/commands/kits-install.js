...
module.exports = new Command("kits:install <githubRepo>")
    ...
    return kits.prepareKitsUpload
        ...
        utils.logSuccess(clc.green.bold("kits: ") + "Fetched configuration file from " + clc.bold(gitRepo));
        ...
        utils.logBullet("Deploying kit " + gitRepo + " as " + clc.bold(runtimeConfig.kitname + "..."));
        return kits.deploy(kitFunctions, options, runtimeConfig, sourceUploadUrl);
    });
});
//# sourceMappingURL=kits-install.js.map