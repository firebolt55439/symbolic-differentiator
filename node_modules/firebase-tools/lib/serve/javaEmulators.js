...
function _runBinary(emulator, command) {
    return new Promise(function (resolve) {
        ...
        emulator.instance.stdout.on("data", function (data) {
            console.log(data.toString());
            emulator.stdout.write(data.toString());
        });
        emulator.instance.stderr.on("data", function (data) {
            utils.logWarning(emulator.name + ": " + data.toString());
        });
        emulator.instance.on("error", function (err) {
        ...
        emulator.instance.once("exit", function (code, signal) {
            if (signal) {
                utils.logLabeledBullet(emulator.name, "emulator has exited upon receiving signal: " + signal);
            }
